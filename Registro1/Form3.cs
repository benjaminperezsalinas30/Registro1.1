...
namespace Registro1
{
    public partial class Form3 : Form
    {
        ...
        public DataTable llenar_grid()
        {
            ...
            string consulta = "SELECT * FROM ADULTO";
        ...
        {
            Conexion.Conectar();
            string insertar = "INSERT INTO ADULTO (CODIGO,NOMBRE,APELLIDO,EDAD,TELEFONO,GENERO)VALUES(@CODIGO,@NOMBRE,@APELLIDO,@EDAD,@TELEFONO,@GENERO)";
        ...
        {
            Conexion.Conectar();
            string actualizar = "UPDATE ADULTO SET CODIGO=@CODIGO, NOMBRE=@NOMBRE, APELLIDO=@APELLIDO, EDAD=@EDAD, TELEFONO=@TELEFONO, GENERO=@GENERO WHERE CODIGO=@CODIGO";
        ...
        {
            Conexion.Conectar();
            string eliminar = "DELETE FROM ADULTO WHERE CODIGO = @CODIGO";
